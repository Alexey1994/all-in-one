...
import procedure           initialize_input            (Input *input, Byte *source, function Byte (*read_byte)(Byte *source), function Boolean (*end_of_data)(Byte *source));
import procedure           deinitialize_input          (Input *input);

import function  Byte      read_byte                   (Input *input);
import function  Byte      input_head                  (Input *input);
import function  Boolean   end_of_input                (Input *input);

import function  Boolean   read_if_next                (Input *input, Byte *next);
