...
import function  Byte*    BeginPaint       (Byte *window, Windows_Paint *paint);
import function  N_32     EndPaint         (Byte *window, Windows_Paint *paint);
...
import function  N_32     InvalidateRect   (Byte *window, Windows_Rectangle *rectangle, N_32 clean);
import function  N_32     UpdateWindow     (Byte *window);
import function  N_32     RedrawWindow     (Byte *window, Windows_Rectangle *region, Byte *update_region, N_32 flags);

import function  Z_32     SetDIBitsToDevice(
    Byte        *device_context,
    Z_32         x,
    Z_32         y,
    N_32         width,
